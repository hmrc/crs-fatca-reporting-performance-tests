...
# crs-fatca-reporting-performance-tests

Performance test suite for the `CRS/FATCA`, using [performance-test-runner](https://github.com/hmrc/performance-test-runner) under the hood.
